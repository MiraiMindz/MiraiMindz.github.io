...
function ClassContent(props: ClassContentProps) {
  ...
  return (
    <div className="font-antonio">
      ...
      <BackNextChapters nextChapLink="/classes/pyless/5" prevChapLink="/classes/pyless/3" markAsCompletedFunction={props.markAsCompletedFunction} updateStateFunction={props.updateStateFunction} />
      </div>
...
export function PyLess4(props: ClassesIndexStateProps) {
  ...
  return (
    <div className='flex flex-col bg-ctp-base text-ctp-text'>
      <Header state={props.state} funcState={props.funcState} title="OOP Básica" sums={<CapsSumPhone refsFuncList={rfs}/>} caps={<CapsLinkPhone currCap={cCap}/>} themeFunc={props.themeFunc} themeState={props.darkLightSwitch} classCompState={updateState}/>
      <PageContent state={props.state} refLinksList={ls} darkLightSwitch={props.darkLightSwitch} markAsCompletedFunction={markThisComplete} updateStateFunction={updateState} cCap={cCap} capTitle="Orientação a Objetos Básica"/>
