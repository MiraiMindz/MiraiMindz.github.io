...
function ClassContent(props: ClassContentProps) {
  ...
  return (
    <div>
      ...
      <ClassChapter1/>
      <ClassChapter2 />
      <BackNextChapters nextChapLink="/classes/pyless/5" prevChapLink="/classes/pyless/3" />
    </div>
  )
}
    ...
    <div className={(props.state ? "blur-sm" : "pt-0 md:pt-16 min-h-screen grow font-leagueGothic")}>
      ...
      <div className="px-8 relative hidden md:flex flex-row">
        ...
        <div className="w-0 grow px-2 text-justify">
          <ClassContent chapterTitle="Orientação a Objetos Básica" refLinksList={props.refLinksList} />
        </div>
        <div className="w-20">
          <CapSumm currCap={4} />
        </div>
