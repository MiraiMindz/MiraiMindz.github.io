...
function ClassChap1Subcap3(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock01}>
      {CBlocks.CodeBlock07}
      </CodeBlock>
    </div>
  )
...
function ClassChap1Subcap4(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock02}>
      {CBlocks.CodeBlock08}
      </CodeBlock>
      <Paragraph>
      caso nós queiramos guardar as informações providas pelo <CodeCite text="input()" />, nós devemos associa-lo a uma variavel
      </Paragraph>
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock03}>
      {CBlocks.CodeBlock09}
      </CodeBlock>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock04}>
      {CBlocks.CodeBlock10}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S1S1(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock05}>
      {CBlocks.CodeBlock11}
      </CodeBlock>
      <Paragraph>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock06}>
      {CBlocks.CodeBlock12}
      </CodeBlock>
      <Paragraph>
      porém, nos podemos sim usar o mesmo tipo de aspas dentro e fora da string, basta ultilizarmos o caractere de escapagem (\)
      </Paragraph>
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock07}>
      {CBlocks.CodeBlock13}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S1S2(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock08}>
      {CBlocks.CodeBlock14}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S1S3(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock09}>
      {CBlocks.CodeBlock15}
      </CodeBlock>
      <Paragraph>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock10}>
      {CBlocks.CodeBlock16}
      </CodeBlock>
      <Paragraph>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock11}>
      {CBlocks.CodeBlock17}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S1S4(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock12}>
      {CBlocks.CodeBlock18}
      </CodeBlock>
      <Paragraph>
...
function ClassChap2Subcap2S2S1(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock13}>
      {CBlocks.CodeBlock19}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S2S2(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock14}>
      {CBlocks.CodeBlock20}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S2S4(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock15}>
      {CBlocks.CodeBlock21}
      </CodeBlock>
      <Paragraph>
...
function ClassChap2Subcap2S2S5(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock16}>
      {CBlocks.CodeBlock22}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S3S1(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock17}>
      {CBlocks.CodeBlock23}
      </CodeBlock>
      <Paragraph>
...
function ClassChap2Subcap2S4S1(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock18}>
      {CBlocks.CodeBlock24}
      </CodeBlock>
      <Paragraph>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock19}>
      {CBlocks.CodeBlock25}
      </CodeBlock>
      <Paragraph>
      o <CodeCite text="not" /> é o mais simples de todos, ele inverte o valor
      </Paragraph>
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock20}>
      {CBlocks.CodeBlock26}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S5S1(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock21}>
      {CBlocks.CodeBlock27}
      </CodeBlock>
...
function ClassChap2Subcap2S5S3(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock22}>
      {CBlocks.CodeBlock28}
      </CodeBlock>
      <Paragraph>
      unicode strings: aceitam escapagens de caracteres unicode
      </Paragraph>
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock23}>
      {CBlocks.CodeBlock29}
      </CodeBlock>
      <Paragraph>
      format strings: aceitam formatação de código
      </Paragraph>
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock24}>
      {CBlocks.CodeBlock30}
      </CodeBlock>
      <Paragraph>
      raw-format strings: a união entre format strings e raw strings
      </Paragraph>
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock25}>
      {CBlocks.CodeBlock31}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S5S4(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock26}>
      {CBlocks.CodeBlock32}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S5S5(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock27}>
      {CBlocks.CodeBlock33}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S5S6(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock28}>
      {CBlocks.CodeBlock34}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap2S5S8(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock30}>
      {CBlocks.CodeBlock37}
      </CodeBlock>
      <Paragraph>
    ...
    <div>
      ...
      <UList>
        <ListItem>
          ...
          <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock32}>
          {CBlocks.CodeBlock39}
          </CodeBlock>
        </ListItem>
        <ListItem>
          forma 2: nas tuples nós podemos omitir o parenteses, apenas separando os argumentos por virgula <CodeCite text="," />
          <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock33}>
          {CBlocks.CodeBlock40}
          </CodeBlock>
        </ListItem>
      </UList>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock34}>
      {CBlocks.CodeBlock41}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap3S3(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock35}>
      {CBlocks.CodeBlock42}
      </CodeBlock>
      <Paragraph>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock36}>
      {CBlocks.CodeBlock43}
      </CodeBlock>
      <Paragraph>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock37}>
      {CBlocks.CodeBlock44}
      </CodeBlock>
      <Paragraph>
      para adicionarmos um item em uma posição especifica nós usamos: <CodeCite text="lista.insert(index, item)" />
      </Paragraph>
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock38}>
      {CBlocks.CodeBlock45}
      </CodeBlock>
      <Paragraph>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock39}>
      {CBlocks.CodeBlock46}
      </CodeBlock>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock40}>
      {CBlocks.CodeBlock47}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap3S4(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock41}>
      {CBlocks.CodeBlock48}
      </CodeBlock>
      <Paragraph>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock42}>
      {CBlocks.CodeBlock49}
      </CodeBlock>
      <Paragraph>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock43}>
      {CBlocks.CodeBlock50}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap3S5(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock44}>
      {CBlocks.CodeBlock51}
      </CodeBlock>
      <Paragraph>
      para fins de conveniencia e legibilidade, nós dividimos o dicionario entre linhas, ficando desta forma
      </Paragraph>
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock45}>
      {CBlocks.CodeBlock52}
      </CodeBlock>
      <Paragraph>
        para acessarmos um valor especifico nós usamos sua chave, desta forma <CodeCite text="dicionario[chave]" />
      </Paragraph>
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock46}>
      {CBlocks.CodeBlock53}
      </CodeBlock>
      <Paragraph>
      para adicionarmos um valor, ou reassociarmos um valor, basta por <CodeCite text="dicionario[chave]=novo_valor" />
      </Paragraph>
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock47}>
      {CBlocks.CodeBlock54}
      </CodeBlock>
    </div>
  )
...
function ClassChap2Subcap4S1(props: ClassChapterProps) {
  ...
  return (
    <div>
      ...
      <CodeBlock darkLightSwitch={props.darkLightSwitch} language='python' answer={CBlocks.AnswerBlock48}>
      {CBlocks.CodeBlock55}
      </CodeBlock>
      <Paragraph>
  ...
  return (
    <div className="w-80 max-w-sm font-bebasNeue border-2 border-ctp-text rounded-xl px-2 py-1 mr-2 fixed top-20 left-8 overscroll-contain overflow-auto scroll-smooth max-h-[80%] bg-ctp-base text-ctp-text">
      ...
      <div>
        ...
        <ToCLink ToCID="1."       linkHashID="01" title="Variaveis, Comentários, print() e input()" level={0}/>
        <ToCLink ToCID="1.1."     linkHashID="02" title="Variaveis" level={1}/>
        <ToCLink ToCID="1.1.1."   linkHashID="03" title="Constantes" level={2}/>
        <ToCLink ToCID="1.2."     linkHashID="04" title="Comentários" level={1}/>
        <ToCLink ToCID="1.2.1."   linkHashID="05" title="SheBang (Sistemas UNIX)" level={2}/>
        <ToCLink ToCID="1.3."     linkHashID="06" title="print()" level={1}/>
        <ToCLink ToCID="1.4."     linkHashID="07" title="input()" level={1}/>
        <ToCLink ToCID="1.4.1."   linkHashID="08" title="Pequena curiosidade" level={2}/>
        <ToCLink ToCID="2."       linkHashID="09" title="Tipos de Dado" level={0}/>
        <ToCLink ToCID="2.1."     linkHashID="10" title="O que é um Dado?" level={1}/>
        <ToCLink ToCID="2.2."     linkHashID="11" title="Dados Primitivos" level={1}/>
        <ToCLink ToCID="2.2.1."   linkHashID="12" title="String (Textos)" level={2}/>
        <ToCLink ToCID="2.2.1.1." linkHashID="13" title="Declaração" level={3}/>
        <ToCLink ToCID="2.2.1.2." linkHashID="14" title="Multi-Line" level={3}/>
        <ToCLink ToCID="2.2.1.3." linkHashID="15" title="fStrings (Formatted Strings)" level={3}/>
        <ToCLink ToCID="2.2.1.4." linkHashID="16" title="Concatenação" level={3}/>
        <ToCLink ToCID="2.2.2"    linkHashID="17" title="Numeros (Ints & Floats) e Operações Aritméticas" level={2}/>
        <ToCLink ToCID="2.2.2.1"  linkHashID="18" title="Ints" level={3}/>
        <ToCLink ToCID="2.2.2.2"  linkHashID="19" title="Floats" level={3}/>
        <ToCLink ToCID="2.2.2.3"  linkHashID="20" title="Operações Aritméticas" level={3}/>
        <ToCLink ToCID="2.2.2.4"  linkHashID="21" title="Divisão" level={3}/>
        <ToCLink ToCID="2.2.2.5"  linkHashID="22" title='"Divisão Verdadeira"' level={3}/>
        <ToCLink ToCID="2.2.3"    linkHashID="23" title="Problemas com Numeros de Ponto Flutuante" level={2}/>
        <ToCLink ToCID="2.2.3.1"  linkHashID="24" title="Bit Overflow" level={3}/>
        <ToCLink ToCID="2.2.3.2"  linkHashID="25" title="Performance" level={3}/>
        <ToCLink ToCID="2.2.4"    linkHashID="26" title="Boolean" level={2}/>
        <ToCLink ToCID="2.2.4.1"  linkHashID="27" title="Operadores Lógicos" level={3}/>
        <ToCLink ToCID="2.2.4.2"  linkHashID="28" title="Curto Circuito" level={3}/>
        <ToCLink ToCID="2.2.3"    linkHashID="29" title="Curiosidades" level={2}/>
        <ToCLink ToCID="2.2.3.1"  linkHashID="30" title="Floats" level={3}/>
        <ToCLink ToCID="2.2.3.2"  linkHashID="31" title="Strings" level={3}/>
        <ToCLink ToCID="2.2.3.3"  linkHashID="32" title="Prefixos" level={3}/>
        <ToCLink ToCID="2.2.3.4"  linkHashID="33" title="Sequencias de escapagem" level={3}/>
        <ToCLink ToCID="2.2.3.5"  linkHashID="34" title="Templates" level={3}/>
        <ToCLink ToCID="2.2.3.6"  linkHashID="35" title="Conversores" level={3}/>
        <ToCLink ToCID="2.2.3.7"  linkHashID="36" title="Especificações da Mini-linguagem de formatação" level={3}/>
        <ToCLink ToCID="2.2.3.8"  linkHashID="37" title="Depuração e padrão printf" level={3}/>
        <ToCLink ToCID="2.3."     linkHashID="38" title="Tipos Compostos" level={1}/>
        <ToCLink ToCID="2.3.1."   linkHashID="39" title="Mutabilidade" level={2}/>
        <ToCLink ToCID="2.3.2."   linkHashID="40" title="Tuples" level={2}/>
        <ToCLink ToCID="2.3.3."   linkHashID="41" title="Listas" level={2}/>
        <ToCLink ToCID="2.3.3.1"  linkHashID="42" title="Matrizes (Lista Multi-Dimensional)" level={3}/>
        <ToCLink ToCID="2.3.4."   linkHashID="43" title="Sets (Conjuntos)" level={2}/>
        <ToCLink ToCID="2.3.5."   linkHashID="44" title="Dicionários" level={2}/>
        <ToCLink ToCID="2.4."     linkHashID="45" title="Conversão e Coerção" level={1}/>
        <ToCLink ToCID="2.4.1."   linkHashID="46" title="Conversão" level={2}/>
...
function CapsSumPhone(props: CapsSumPhoneProps) {
  ...
  return (
    <div className={vars.textSizes2XL2 + 'font-leagueGothic'}>
      <ToCLink ToCID=""         linkRefFunc={refsFuncList[0]}   title="Fundamentos do Python I" level={0}/>
      <ToCLink ToCID="1."       linkRefFunc={refsFuncList[1]}   title="Variaveis, Comentários, print() e input()" level={0}/>
      <ToCLink ToCID="1.1."     linkRefFunc={refsFuncList[2]}   title="Variaveis" level={1}/>
      <ToCLink ToCID="1.1.1."   linkRefFunc={refsFuncList[3]}   title="Constantes" level={2}/>
      <ToCLink ToCID="1.2."     linkRefFunc={refsFuncList[4]}   title="Comentários" level={1}/>
      <ToCLink ToCID="1.2.1."   linkRefFunc={refsFuncList[5]}   title="SheBang (Sistemas UNIX)" level={2}/>
      <ToCLink ToCID="1.3."     linkRefFunc={refsFuncList[6]}   title="print()" level={1}/>
      <ToCLink ToCID="1.4."     linkRefFunc={refsFuncList[7]}   title="input()" level={1}/>
      <ToCLink ToCID="1.4.1."   linkRefFunc={refsFuncList[8]}   title="Pequena curiosidade" level={2}/>
      <ToCLink ToCID="2."       linkRefFunc={refsFuncList[9]}   title="Tipos de Dado" level={0}/>
      <ToCLink ToCID="2.1."     linkRefFunc={refsFuncList[10]}  title="O que é um Dado?" level={1}/>
      <ToCLink ToCID="2.2."     linkRefFunc={refsFuncList[11]}  title="Dados Primitivos" level={1}/>
      <ToCLink ToCID="2.2.1."   linkRefFunc={refsFuncList[12]}  title="String (Textos)" level={2}/>
      <ToCLink ToCID="2.2.1.1." linkRefFunc={refsFuncList[13]}  title="Declaração" level={3}/>
      <ToCLink ToCID="2.2.1.2." linkRefFunc={refsFuncList[14]}  title="Multi-Line" level={3}/>
      <ToCLink ToCID="2.2.1.3." linkRefFunc={refsFuncList[15]}  title="fStrings (Formatted Strings)" level={3}/>
      <ToCLink ToCID="2.2.1.4." linkRefFunc={refsFuncList[16]}  title="Concatenação" level={3}/>
      <ToCLink ToCID="2.2.2"    linkRefFunc={refsFuncList[17]}  title="Numeros (Ints & Floats) e Operações Aritméticas" level={2}/>
      <ToCLink ToCID="2.2.2.1"  linkRefFunc={refsFuncList[18]}  title="Ints" level={3}/>
      <ToCLink ToCID="2.2.2.2"  linkRefFunc={refsFuncList[19]}  title="Floats" level={3}/>
      <ToCLink ToCID="2.2.2.3"  linkRefFunc={refsFuncList[20]}  title="Operações Aritméticas" level={3}/>
      <ToCLink ToCID="2.2.2.4"  linkRefFunc={refsFuncList[21]}  title="Divisão" level={3}/>
      <ToCLink ToCID="2.2.2.5"  linkRefFunc={refsFuncList[22]}  title='"Divisão Verdadeira"' level={3}/>
      <ToCLink ToCID="2.2.3"    linkRefFunc={refsFuncList[23]}  title="Problemas com Numeros de Ponto Flutuante" level={2}/>
      <ToCLink ToCID="2.2.3.1"  linkRefFunc={refsFuncList[24]}  title="Bit Overflow" level={3}/>
      <ToCLink ToCID="2.2.3.2"  linkRefFunc={refsFuncList[25]}  title="Performance" level={3}/>
      <ToCLink ToCID="2.2.4"    linkRefFunc={refsFuncList[26]}  title="Boolean" level={2}/>
      <ToCLink ToCID="2.2.4.1"  linkRefFunc={refsFuncList[27]}  title="Operadores Lógicos" level={3}/>
      <ToCLink ToCID="2.2.4.2"  linkRefFunc={refsFuncList[28]}  title="Curto Circuito" level={3}/>
      <ToCLink ToCID="2.2.3"    linkRefFunc={refsFuncList[29]}  title="Curiosidades" level={2}/>
      <ToCLink ToCID="2.2.3.1"  linkRefFunc={refsFuncList[30]}  title="Floats" level={3}/>
      <ToCLink ToCID="2.2.3.2"  linkRefFunc={refsFuncList[31]}  title="Strings" level={3}/>
      <ToCLink ToCID="2.2.3.3"  linkRefFunc={refsFuncList[32]}  title="Prefixos" level={3}/>
      <ToCLink ToCID="2.2.3.4"  linkRefFunc={refsFuncList[33]}  title="Sequencias de escapagem" level={3}/>
      <ToCLink ToCID="2.2.3.5"  linkRefFunc={refsFuncList[34]}  title="Templates" level={3}/>
      <ToCLink ToCID="2.2.3.6"  linkRefFunc={refsFuncList[35]}  title="Conversores" level={3}/>
      <ToCLink ToCID="2.2.3.7"  linkRefFunc={refsFuncList[36]}  title="Especificações da Mini-linguagem de formatação" level={3}/>
      <ToCLink ToCID="2.2.3.8"  linkRefFunc={refsFuncList[37]}  title="Depuração e padrão printf" level={3}/>
      <ToCLink ToCID="2.3."     linkRefFunc={refsFuncList[38]}  title="Tipos Compostos" level={1}/>
      <ToCLink ToCID="2.3.1."   linkRefFunc={refsFuncList[39]}  title="Mutabilidade" level={2}/>
      <ToCLink ToCID="2.3.2."   linkRefFunc={refsFuncList[40]}  title="Tuples" level={2}/>
      <ToCLink ToCID="2.3.3."   linkRefFunc={refsFuncList[41]}  title="Listas" level={2}/>
      <ToCLink ToCID="2.3.3.1"  linkRefFunc={refsFuncList[42]}  title="Matrizes (Lista Multi-Dimensional)" level={3}/>
      <ToCLink ToCID="2.3.4."   linkRefFunc={refsFuncList[43]}  title="Sets (Conjuntos)" level={2}/>
      <ToCLink ToCID="2.3.5."   linkRefFunc={refsFuncList[44]}  title="Dicionários" level={2}/>
      <ToCLink ToCID="2.4."     linkRefFunc={refsFuncList[45]}  title="Conversão e Coerção" level={1}/>
      <ToCLink ToCID="2.4.1."   linkRefFunc={refsFuncList[46]}  title="Conversão" level={2}/>
      <ToCLink ToCID="2.4.2."   linkRefFunc={refsFuncList[47]}  title="Coerção" level={2}/>
      <ToCLink ToCID="2.5."     linkRefFunc={refsFuncList[48]}  title="sum() & len()" level={1}/>
    </div>
  )
}
