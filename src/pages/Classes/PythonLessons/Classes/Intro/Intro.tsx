...
function ClassChapter1(props: ClassChapterProps) {
  ...
  return (
    <div className={vars.textSizesBASE2}>
      <SubTitle titleId="2" chapterTitle="O que é programação?" refLink={refsLink[1]}/>
...
function ClassChapter2(props: ClassChapterProps) {
  ...
  return (
    <div className={vars.textSizesBASE2}>
      <SubTitle chapterTitle="Linguagens de programação e suas classificações" titleId="3" refLink={refsLink[2]} />
...
function CapsSumPhone(props: CapsSumPhoneProps) {
  ...
  return (
    <div className={vars.textSizes2XL2 + 'font-leagueGothic'}>
      <ToCLink  ToCID=""   linkRefFunc={refsFuncList[0]} title="Introdução a Programação" level={0}/>
      <ToCLink  ToCID="1." linkRefFunc={refsFuncList[1]} title="O que é programação?" level={1}/>
      <ToCLink  ToCID="2." linkRefFunc={refsFuncList[2]} title="Linguagens de programação e suas classificações" level={1}/>
    </div>
  )
}
